...
<body class="as-theme-light-heroimage">
    ...
    <div class="stack">
        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div>
                <p>
                    payment_method_id que se usó para pagar, el monto pagado, el número de orden del pedido y el ID de pago de Mercado Pago (approved)
i) Se deberá configurar para que desde el checkout de Mercado Pago el retorno en caso de pago aprobado sea automático (auto_return).
